 ...
 */
 ...
 $mimo_maps_icons_select1 = array(
		 ...
		 $mimo_maps_icons_select = array_flip($mimo_maps_icons_select1 );  
...
<div class="wrap">
    ...
    <div class="postbox">
			...
			<h3 class="hndle"><span><?php _e( 'Mimo Maps', 'mimo-maps' ); ?></span></h3>
			
			<div class="inside">

				<p> <?php _e( 'If you like this plugin please rate it. find support at ', 'mimo-maps' ); ?><a href="http://www.mimo.media"><?php _e( 'mimo.media', 'mimo-maps' ); ?></a></p>
	...
	<ul>
	    ...
	    <li><a href="#tabs-2"><?php _e( 'Style', 'mimo-maps' ); ?></a></li>
	    <li><a href="#tabs-3"><?php _e( 'Markers', 'mimo-maps' ); ?></a></li>
	    
	    
	</ul>
	<div id="tabs-1" class="wrap">
		<div class="postbox">
			<h3 class="hndle"><span><?php _e( 'General Settings', 'mimo-maps' ); ?></span></h3>
			<div class="inside">
			...
			'name' => __( 'Google API key', 'mimo-maps' ),
			'desc' => __( 'Get your API key and insert it here', 'mimo-maps' ),
	    ...
	    $cmb->add_field(array(
			...
			'name' => __( 'Post Id', 'mimo-maps' ),
			'desc' => __( 'Choose a post id to show only one post in this map', 'mimo-maps' ),
	     ...
	     $cmb->add_field(array(
			...
			'name' => __( 'Category Slug', 'mimo-maps' ),
			'desc' => __( 'Choose a category slug to show only one post in this map', 'mimo-maps' ),
	     ...
	     $cmb->add_field(array(
			...
			'name' => __( 'Post Locations per page', 'mimo-maps' ),
			'desc' => __( 'Choose a posts_per_page value, -1 = infinite posts', 'mimo-maps' ),
		    ...
		    $cmb->add_field(array(
				...
				'name' => __( 'Map Height in Px or Em', 'mimo-maps' ),
				'desc' => __( 'Give a height to the map, ie: "300px","30em"', 'mimo-maps' ),
		    ...
		    $cmb->add_field(array(
				...
				'name' => __( 'Map Zoom', 'mimo-maps' ),
				'desc' => __( 'Give a zoom to the map, ie: "5","12","16"', 'mimo-maps' ),
			...
			'name' => __( 'License key(comming soon)', 'mimo-maps' ),
			'desc' => __( 'Get the Pro license of this plugin to get amazing features, comming soon', 'mimo-maps' ),
	...
	<div id="tabs-2" class="wrap">
		<div class="postbox">
			<h3 class="hndle"><span><?php _e( 'Map Style', 'mimo-maps' ); ?></span></h3>
			<div class="inside">
	    ...
	    $cmb->add_field( array(
		    ...
		    $cmb->add_field( array(
				...
				'name' => __( 'Highway Fill', 'mimo-maps' ),
		    ...
		    $cmb->add_field( array(
				...
				'name' => __( 'Highway Stroke', 'mimo-maps' ),
		    ...
		    $cmb->add_field( array(
				...
				'name' => __( 'Labels Stroke', 'mimo-maps' ),
		    ...
		    $cmb->add_field( array(
				...
				'name' => __( 'Administrative Fill', 'mimo-maps' ),
		    ...
		    $cmb->add_field( array(
				...
				'name' => __( 'Administrative Stroke', 'mimo-maps' ),
	...
	<div id="tabs-3" class="wrap">
		<h3 class="hndle"><span><?php _e( 'Set Posts Colors and Icons', 'mimo-maps' ); ?></span></h3>
	    ...
	    $group_field_id =  $cmb->add_field( array(
			...
			'type'        => 'group',
			'description' => __( 'The category color', 'mimo-maps' ),
			'options'     => array(
				'group_title'   => __( 'Color {#}', 'mimo-maps' ), // {#} gets replaced by row number
				'add_button'    => __( 'Add Another Color', 'mimo-maps' ),
				'remove_button' => __( 'Remove Color', 'mimo-maps' ),
			),
		) );
	    

	    $cmb->add_group_field( $group_field_id, array(
			'name' => __( 'Category Color', 'mimo-maps' ),
			'desc' => __( 'Choose a color to apply to acategory icons and info', 'mimo-maps' ),
	    ...
	    $cmb->add_group_field( $group_field_id, array(
			...
			'name' => __( 'Icon', 'mimo-maps' ),
			'desc' => __( 'Choose icon','mimo-maps' ),
			'id' => $this->plugin_prefix . '_tax_icon',
			'type' => 'select',
			'show_option_none' => true,
			'options' => $mimo_maps_icons_select,
		    ) 
	    );
	 	...
	 	$cmb->add_group_field( $group_field_id, array(
			...
			'name'             => __( 'Category', 'mimo-maps' ),
			'desc'             => __( 'Choose a category to apply settings', 'mimo-maps' ),
