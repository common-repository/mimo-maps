 ...
 */
function mimo_maps_get_language() {
 ...
 */
function mimo_maps_register_string( $plugin_name_human_format, $string_name, $value ) {
 ...
 * @param     string   $string_name               The name of the string
 */
function mimo_maps_deregister_string( $plugin_name_human_format, $string_name ) {
 ...
 * @param     string   $value					  The value
 */
function mimo_maps_get_string( $plugin_name_human_format, $string_name, $value ) {
